package AndroidProject.MicrosoftTeams;
...
//	    HttpCommandExecutor executor = new HttpCommandExecutor(new URL("http://127.0.0.1:4723"));
//	    driver = new AndroidDriver(executor, caps);
	   ...
	   @BeforeMethod
        ...
        allowButton.click();
		WebElement emailField = driver.findElement(By.id("com.microsoft.teams:id/edit_email_refresh"));
	        emailField.clear();
	        emailField.sendKeys("afnan.kharoof@axsos.academy");
	        WebElement nextButton = driver.findElement(By.id("com.microsoft.teams:id/sign_in_button_refresh"));
	        nextButton.click();
	        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	        WebElement passwordField = driver.findElement(By.xpath("//android.widget.EditText[@password='true']"));
	        passwordField.clear();
	        passwordField.sendKeys("Ghaith123");
	        WebElement signInButton = driver.findElement(By.xpath("//android.widget.Button[@resource-id=\"idSIButton9\"]"));
	        signInButton.click();
	        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	        WebElement Next = driver.findElement(By.id("com.microsoft.teams:id/action_next_button"));
	        Next.click();
	        Next.click();
	        WebElement GoIt = driver.findElement(By.id("com.microsoft.teams:id/action_last_button"));
	        GoIt.click();
	        WebElement GoIt2 = driver.findElement(By.id("com.microsoft.teams:id/button_got_it"));
	        GoIt2.click();
	        ...
	        boolean E=true;
	        if (E) {
	            WebElement homeScreen = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout"));
...
//		        return new Object[][] {
//		            {"afnan.kharoof@axsos.academy", "Ghaith123", true}
...
//			 
		 @Test(priority=1)
		    public void testSendMessage() {
		        WebElement chatTab = driver.findElement(By.xpath("(//android.widget.ImageView[@resource-id=\"com.microsoft.teams:id/bb_bottom_bar_icon\"])[2]"));
		        chatTab.click();

		        WebElement newChatButton = driver.findElement(By.xpath("//android.widget.TextView[@resource-id=\"com.microsoft.teams:id/chat_display_name\" and @text=\"Othman, Tasneim\"]"));
		        newChatButton.click();
//
//		        WebElement recipientField = driver.findElement(By.id("com.microsoft.teams:id/search_contact_box"));
//		        recipientField.sendKeys("tasneim");

		        WebElement messageField = driver.findElement(By.id("com.microsoft.teams:id/message_area_edit_text"));
		        messageField.sendKeys("Hello, this is a test message!");
		        WebElement send = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Send message\"]"));
		        send.click();
		       

		       

		        WebElement lastMessage = driver.findElement(By.xpath("//android.widget.TextView[@content-desc=\"Hello, this is a test message!\"]"));
